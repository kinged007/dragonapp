...
from .config import ShlinkConfig
...
Module.register(
    ...
    config_class = ShlinkConfig, # Use a BaseModel instance.
    ...
    database = [ ShlinkDomainDocument, ShlinkAnalyticsDocument, ShlinkShortLinkDocument],
    ...
    # ],
    # dependencies = ['users','ai','messaging'], # Do a dependency check of other modules and raise an error if missing dependencies.
