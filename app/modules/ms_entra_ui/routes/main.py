...
# Import routes
from . import modules, config, tools, tickets
...
app.include_router(tools.router, prefix="/tool", dependencies=None, tags=["Tool"])
app.include_router(tickets.router, prefix="/ticket", dependencies=None, tags=["Ticket"])
...
log.info("Frontend Panel Active")