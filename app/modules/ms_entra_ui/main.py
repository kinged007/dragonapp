...
Module.register(
    ...
    config_class = Config, # Use a BaseModel format.
    ...
    # labels = ['predefined_label_option' ], # Predefined labels that may be selected in the frontend panel, and applied to a user.
