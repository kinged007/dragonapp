"""
Python file to render various fields in the frontend, using NiceGUI
"""
...
def table_buttons(table:ui.table, options:List[Literal['fullscreen','columns','search','refresh']], real_rows:List[dict] = None) -> ui.row:
    """
